...
/*
using CT.DDS.ByteArrayFormatter;

using CT.DDS.Pgp.Middleware;

using CT.DDS.Pgp.TestApp;
...
namespace CT.DDS.PgpTestApp.Tests {
    ...
    public class ValuesControllerTests {
        ...
        public async Task CheckEncryption() {
            ...
            var privateKey = File.ReadAllText("receiver-private.txt");
        ...
        public async Task Post() {
            ...
            using (var outStream = new MemoryStream()) {
                ...
                using (var inStream = new MemoryStream(encrypted)) {
                    ...
                    recoveredText = Encoding.UTF8.GetString(outStream.ToArray());
